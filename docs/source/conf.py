...
# Sphinx 7+ uses 'root_doc' (alias of deprecated 'master_doc')
root_doc = "index"

# The language for autogenerated content
language = "en"
...
latex_documents = [
    (root_doc, project + ".tex", project + " Documentation", meta.author, "manual"),
]
...
man_pages = [(root_doc, project, project + " Documentation", [author], 1)]
